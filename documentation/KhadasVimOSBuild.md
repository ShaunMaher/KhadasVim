...
## Caveats
  * At the time of writing, I have been unable to get any Device Tree file
    ...
    Device tree generated by the Khadas fork of the 4.9 kernel.
...
touch .scmversion
make -j3 ARCH=arm64 CROSS_COMPILE=aarch64-linux-gnu- Image ${DTBRELPATH}${DTB}.dtb modules
...
```
mkdir -p /tmp/kvimXhttps://stackoverflow.com/questions/25090803/linux-kernel-kernel-version-string-appended-with-either-or-dirty
